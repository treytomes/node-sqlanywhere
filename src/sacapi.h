 ...
 * \salink{Embedded SQL data types, "http://dcx.sap.com/goto?page=sa160/en/dbprogramming/esqlvar.html", "programming", "esqlvar"}.
 *
 * \hideinitializers
 ...
 * \salink{db_register_a_callback function, "http://dcx.sap.com/goto?page=sa160/en/dbprogramming/db-register-a-callback-esql.html", "programming", "db-register-a-callback-esql"}.
 *
 * \hideinitializers
 ...
 * \salink{Connection parameters, "http://dcx.sap.com/goto?page=sa160/en/dbadmin/da-conparm.html", "dbadmin", "da-conparm"} and 
 * \salink{SQL Anywhere database connections, "http://dcx.sap.com/goto?page=sa160/en/dbadmin/da-dbconnections.html", "dbadmin", "da-dbconnections"}.
 *
 ...
 * \salink{row_counts option [database], "http://dcx.sap.com/goto?page=sa160/en/dbadmin/row-counts-option.html", "dbadmin", "row-counts-option"}.
 *
 * \param sqlany_stmt A statement object that was executed by
 *     sqlany_execute() or sqlany_execute_direct().
 ...
 * \salink{SQL Anywhere error messages sorted by SQLCODE, "http://dcx.sap.com/goto?page=sa160/en/saerrors/sa-errors-by-sqlcode.html", "errors", "sa-errors-by-sqlcode"}.
 *
 ...
 * \salink{SQL Anywhere error messages sorted by SQLSTATE, "http://dcx.sap.com/goto?page=sa160/en/saerrors/sa-errors-by-sqlstate.html", "errors", "sa-errors-by-sqlstate"}.
 *
 * \param sqlany_conn A connection object returned from sqlany_new_connection().
